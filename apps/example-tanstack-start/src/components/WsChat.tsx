...
// NOTE: VITE_API_URL is baked in at build time.
        ...
        {log.length === 0 ? (
          ...
          log.map((entry, i) => (
            <div
              ...
              data-testid={
                entry.direction === 'received' ? 'ws-message' : 'ws-sent-message'
              }
            >
              {entry.text}
            </div>
