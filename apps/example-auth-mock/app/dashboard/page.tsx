...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    setTok(t);
    // Initial load of the PROTECTED resource, carrying the Bearer token. This
    // request goes through the proxy and is recorded; the recorder redacts the
    // Authorization header (and the session cookie) from the saved recording.
